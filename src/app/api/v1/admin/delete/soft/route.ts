 ...
 * POST /api/v1/admin/delete/soft
 *
 * Soft delete a record (single approval required)
 */
...
export async function POST(request: NextRequest) {
  try {
      ...
      return NextResponse.json(
        {
          ...
          message: 'Admin role required for soft delete',
        },
        { status: 403 }
      );
    }
    ...
    // Execute soft delete
    const result = await softDeleteRecord(body);
